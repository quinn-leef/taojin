...
public interface BrandFeign {
    ...
    Result<PageInfo> findPage(@RequestBody(required = false) Brand brand, @PathVariable("page") int page, @PathVariable("size") int size);
     ...
     */
    @PutMapping(value="/{id}")
    Result update(@RequestBody Brand brand, @PathVariable("id") Integer id);
     ...
     */
    @GetMapping("/{id}")
    Result<Brand> findById(@PathVariable("id") Integer id);
