...
public interface OrderFeign {
    ...
    Result<PageInfo> findPage(@RequestBody(required = false) Order order, @PathVariable("page") int page, @PathVariable("size")  int size);
     ...
     */
    @PutMapping(value="/{id}")
    Result update(@RequestBody Order order,@PathVariable("id") String id);
