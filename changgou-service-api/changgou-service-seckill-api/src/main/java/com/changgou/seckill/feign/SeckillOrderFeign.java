...
public interface SeckillOrderFeign {
    ...
    Result<PageInfo> findPage(@RequestBody(required = false) SeckillOrder seckillOrder, @PathVariable("page") int page, @PathVariable("size")  int size);
     ...
     */
    @PutMapping(value="/{id}")
    Result update(@RequestBody SeckillOrder seckillOrder,@PathVariable("id") Long id);
